    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.CharField(default='Short description', max_length=200)),
                ('cooking_time', models.TimeField()),
                ('ingredients', models.TextField()),
                ('steps', models.TextField()),
                ('image', models.ImageField(blank=True, default='https://res.cloudinary.com/dlorcehfq/image/upload/v1678551729/default_profile_y7itwz.jpg', upload_to='images/')),
